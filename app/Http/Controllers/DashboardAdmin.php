...
class DashboardAdmin extends Controller
{
    ...
    {   
        ...
        return view('pages/admin/dashboard', ['barang'=>$barang, 'barang_masuk'=>$barang_masuk, 'customer'=>$customer, 'sales'=>$sales, 'barangall'=>$barangall, 'customerall'=>$customerall, 'barang_masukall'=>$barang_masukall, 'salesall'=>$salesall], compact('data'));
    }
}